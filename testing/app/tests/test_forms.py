...
class SomethingFormRenderTest(SimpleTestCase):
    ...
    def test_assert_integer_render(self):
        self.assertEqual(
            ...
            u'<input data-mask="integer" name="something_dfield_integer" type="text" value="%s" />' % self.something.something_dfield_integer
        )
    ...
    def test_assert_charfield_render(self):
        self.assertEqual(
            ...
            u'<input data-mask="charfield" name="something_dfield_charfield" type="text" value="%s" />' % self.something.something_dfield_charfield
        )
    ...
    def test_assert_date_render(self):
        self.assertEqual(
            ...
            u'<input data-mask="date" name="something_dfield_date" type="text" value="%s" />' % self.something.something_dfield_date.strftime('%d/%m/%Y')
        )
    ...
    def test_assert_datetime_render(self):
        self.assertEqual(
            ...
            u'<input data-mask="datetime" name="something_dfield_datetime" type="text" value="%s" />' % self.something.something_dfield_datetime.strftime('%d/%m/%Y %H:%M:%S')
        )
    ...
    def test_assert_monetary_render(self):
        self.assertEqual(
            ...
            u'<input data-mask="monetary" name="something_dfield_monetary" type="text" value="%s" />' % self.something.something_dfield_monetary
        )
    ...
    def test_assert_textarea_render(self):
        self.assertEqual(
            ...
            u'<textarea cols="40" data-mask="textarea" name="something_dfield_textarea" rows="10">\r\n[&#39;1&#39;, &#39;2&#39;, &#39;3&#39;]</textarea>'
        )
    ...
    def test_assert_float_render(self):
        self.assertEqual(
            ...
            u'<input data-mask="float" name="something_dfield_float" type="text" value="%s" />' % self.something.something_dfield_float
        )
